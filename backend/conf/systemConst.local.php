...
const DISPLAY_ERROR = 1;

const WEB_SRC = 'https://localhost:8080';

const ADMIN_SRC = 'http://localhost:8081';
...
const MAIL_ADMIN_WEB_SRC = 'http://localhost:8081';
...
const IS_DISPLAY_MEMBER_CODE_QR = true;

const IS_DISPLAY_MEMBER_CODE_BAR = false;

const SMTP_HOST = 'localhost';

const SMTP_USER_NAME = 'no_reply@example.local';

const SMTP_PASSWORD = '';

const SMTP_SENDER_EMAIL = 'no_reply@example.local';
