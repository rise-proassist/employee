...
abstract class BaseController {
	...
	function __construct() {
		...
		// ヘッダ情報をロギング
		$this->putRequestLog(getallheaders());

		// リクエスト
		$this->_request = new Request();

		if ($this->_request->getPost())
			$this->putRequestLog($this->_request->getPost(), '[Request-POST]');

		if ($this->_request->getQuery())
			$this->putRequestLog($this->_request->getQuery(), '[Request-GET]');
	 ...
	 *
	 */
	private function putRequestLog($request, $prefix = '[Request]') {
